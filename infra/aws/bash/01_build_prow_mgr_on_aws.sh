...
echo "Prow mgr build finished..."
echo "Please login into AWS and get the AWS_VPC_ID and subnets"
echo "Set the VPC and subnet variables in cluster_config.yaml and then run 02_build_prow_clients_on_aws.sh"
